        ...
        <div class="col-full">
            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main" >
                    <div class="posts">
                        <h3>Все посты категории </h3><h1>{{$category->categories}}</h1>
                                ...
                                <header class="entry-header">
                                    ...
                                    <div class="entry-meta">
                                        ...
                                        @foreach($post->categories as $categor)
                                            <div class="cat-links">
                                                <a href="{{route('posts-by-category', $categor->key)}}" rel="category tag">{{$categor->categories}}</a>
                                            </div>
                                        @endforeach
                                        <span class="posted-on">
                                 {{--<a href="#" rel="bookmark">--}}
                                     <div class="label">Создан:</div>
                                 <time class="entry-date published" datetime="2016-10-13T14:53:25+00:00">{{$post->created_at->format('d.m.Y г. в H:i')}}</time>
                                 {{--</a>--}}
                                 </span>
                                        <div class="author">
