                                                            ...
                                                            <div class="widget widget_nav_menu kc-elm kc-css-1908114">
                                                                <div class="menu-pages-menu-1-container">
                                                                    <ul id="menu-pages-menu-5" class="menu">
                                                                        <li class="nav-title menu-item"><a href="#">Продукты</a></li>
                                                                        <li class="menu-item"><a href="{{route('form-action-new')}}">Добавление</a></li>
                                                                        {{--<li class="menu-item"><a href="#">Обновление</a></li>--}}
                                                                        <li class="menu-item"><a href="{{route('products-list')}}">Редактирование \ Удаление</a></li>
                                                                        {{--<li class="menu-item"><a href="home-v4.html">Home--}}
                                                                                {{--v4</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="home-v5.html">Home--}}
                                                                                {{--v5</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="home-v6.html">Home--}}
                                                                                {{--v6</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="home-v7.html">Home--}}
                                                                                {{--v7</a></li>--}}
                                                                        {{--<li class="nav-title menu-item"><a href="#">User--}}
                                                                                {{--Account</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="login-and-register.html">My--}}
                                                                                {{--Account</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="track-order.html">Track--}}
                                                                                {{--Order</a></li>--}}
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                {{--<div class="menu-pages-menu-2-container">--}}
                                                                    {{--<ul id="menu-pages-menu-6" class="menu">--}}
                                                                        {{--<li class="nav-title menu-item"><a href="#">Shop--}}
                                                                                {{--Pages</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-grid-3-column.html">Shop--}}
                                                                                {{--Grid 3 Column</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-grid-4-column.html">Shop--}}
                                                                                {{--Grid 4 Column</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-grid-6-column.html">Shop--}}
                                                                                {{--Grid 6 Column</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-listing.html">Shop--}}
                                                                                {{--Listing</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-list-2-column.html">Shop--}}
                                                                                {{--List 2 Column</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-list-no-images.html">Shop--}}
                                                                                {{--List No Images</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-list-no-images-parallax.html">Shop--}}
                                                                                {{--List No Image Parallax</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-sidebar-grid-3-column.html">Shop--}}
                                                                                {{--Sidebar Grid 3 Column</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-sidebar-listing.html">Shop--}}
                                                                                {{--Sidebar Listing</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-sidebar-list-2-column.html">Shop--}}
                                                                                {{--Sidebar List 2 Column</a></li>--}}
                                                                    {{--</ul>--}}
                                                                {{--</div>--}}
                                                            {{--</div>--}}
                                                        {{--</div>--}}
                                                                ...
                                                                {{--<div class="menu-pages-menu-3-container">--}}
                                                                    {{--<ul id="menu-pages-menu-7" class="menu">--}}
                                                                        {{--<li class="nav-title menu-item"><a href="#">Shop--}}
                                                                                {{--Pages – Dark</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-dark-grid-3-column.html">Shop--}}
                                                                                {{--Dark Grid 3 Column</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-dark_list.html">Shop Dark--}}
                                                                                {{--List</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-dark_list-2-column.html">Shop--}}
                                                                                {{--Dark List 2 Column</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="shop-dark-list-no-images.html">Shop--}}
                                                                                {{--Dark List No Images</a></li>--}}
                                                                        {{--<li class="nav-title menu-item current_page_parent">--}}
                                                                            {{--<a href="blog.html">Blog Pages</a></li>--}}
                                                                        {{--<li class="menu-item current_page_parent"><a--}}
                                                                                    {{--href="blog.html">Blog</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="blog-full-width.html">Blog--}}
                                                                                {{--Fullwidth</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="blog-full-width-grid.html">Blog--}}
                                                                                {{--Fullwidth Grid</a></li>--}}
                                                                ...
                                                                {{--<div class="menu-pages-menu-4-container">--}}
                                                                    {{--<ul id="menu-pages-menu-8" class="menu">--}}
                                                                        {{--<li class="nav-title menu-item"><a--}}
                                                                                    {{--href="single-product-v1.html">Single--}}
                                                                                {{--Product Style</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="single-product-v1.html">Single--}}
                                                                                {{--Product v1</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="single-product-v2.html">Single--}}
                                                                                {{--Product v2</a></li>--}}
                                                                        {{--<li class="menu-item"><a--}}
                                                                                    {{--href="single-product-v3.html">Single--}}
                                                                                {{--Product v3</a></li>--}}
                                                                        {{--<li class="nav-title menu-item"><a href="#">Template--}}
                                                                                {{--Pages</a></li>--}}
                                                                        ...
                                                                        {{--<li class="menu-item"><a--}}
                                                                                ...
                                                                                {{--&amp; Conditions</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="faq-v1.html">FAQ--}}
                                                                                {{--v1</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="faq-v2.html">FAQ--}}
                                                                                {{--v2</a></li>--}}
                                                                        {{--<li class="menu-item"><a href="404.html">404</a>--}}
                                                                        {{--</li>--}}
                                                                    {{--</ul>--}}
                                                                {{--</div>--}}
                                                            {{--</div>--}}
                ...
                <div class="handheld-navigation">
                    ...
                    <ul class="menu">
                        ...
                        @foreach($menus->getMenu() as $menu)
                            <li class="menu-item"><a href="{{route('food', $menu->key)}}"><i
                                            class="po {{$menu->icon}}"></i>{{$menu->name}}</a></li>
                        @endforeach
