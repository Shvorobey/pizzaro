<footer id="colophon" class="site-footer footer-v1" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="col-full">
            ...
            <div class="site-address">
                <ul class="address">
                    <li>Pizzaro</li>
                    <li>Одесса, ул. Дерибасовская, 7</li>
                    <li>Телефон +38 067 514-45-10</li>
                </ul>
            </div>
            <div class="site-info">
                <p class="copyright">Copyright &copy; 2018 Alexandr Shvorobey. <br> All rights reserved.</p>

            </div>
            <p><a class="address" href="#top"><font size="5" color="aqua" face="Arial">Вернуться в начало</font></a></p>
            <!-- .site-info -->      <a role="button" class="footer-action-btn" data-toggle="collapse" href="#footer-map-collapse"><i class="po po-map-marker"></i>Мы на карте</a>
